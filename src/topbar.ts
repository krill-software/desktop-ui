...
function addResizeGuards(bar: HTMLElement): void {
...
function iconButton(label: string, svg: string, kind?: string): HTMLButtonElement {
...
export function buildMainTopbar(): HTMLElement {
...
export function buildAuxTopbar(): { auxTopbar: HTMLElement; hamburger: HTMLElement; theme: HTMLElement } {
  const bar = document.createElement("div");
